...
function Handle_Operator(Next_Operator) {
    ...
    // when an operator key is pressed, we convert the current niumber
    ...
    // if the Perform_Calculation ojbect and the function that matches the
